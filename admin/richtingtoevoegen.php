...
{	
	...
	echo "</br>";
	echo "</br>";
	//knop weergeven om trg te keren
...
{
?>
              <form action="richtingtoevoegen.php" method="post">
                <p>Naam richting:
  <input type="text" name="richting" size="60" />
  </p><input type='submit' name="verzend" value="Richting toevoegen !" /><p>
  <?php
